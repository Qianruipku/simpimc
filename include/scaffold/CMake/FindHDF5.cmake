...
IF(BUILD_STATIC)
    FIND_LIBRARY(HDF5_LIB libhdf5.a $ENV{HDF5_HOME}/lib $ENV{HDF5_HOME}/lib64 ${SCAFFOLD_INSTALL_DIR}/lib NO_DEFAULT_PATH)
    FIND_LIBRARY(HDF5_CPP_LIB libhdf5_cpp.a $ENV{HDF5_HOME}/lib $ENV{HDF5_HOME}/lib64 ${SCAFFOLD_INSTALL_DIR}/lib NO_DEFAULT_PATH)
ELSE()
